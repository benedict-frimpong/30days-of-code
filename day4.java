...
Task
Write a Person class with an instance variable, age, and  a constructor that takes an integer,initaAage, as a parameter. The constructor must assign initaAage to age after confirming the argument passed as initaAage is not negative; if a negative argument is passed as initaAage, the constructor should set age to 0 and print Age is not valid, setting age to 0.. 
